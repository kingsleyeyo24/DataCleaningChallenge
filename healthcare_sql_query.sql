...
-- To understand the age range of the patients.
...
-- To identify the predominant gender and health conditions.
...
-- I analyzed the correlation between Age and Employment Status to predict and handle NULL values in the Education column.
